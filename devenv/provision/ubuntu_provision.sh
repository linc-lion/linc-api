...
#cat << EOF1 | sudo tee -a /etc/mongodb.conf
...
# App Configuration
sudo rm -fr /home/vagrant/app/venv /home/vagrant/linc-api/venv /home/vagrant/linc-webapp/venv /home/vagrant/linc-website/venv 2> /dev/null
...
msg "Starting provision for python LINC-Website app..."
# dependencies for pycurl
virtualenv --python=python3.5 --prompt=" LINC-WebApp " /home/vagrant/linc-website/venv
msg "Install Python Dependencies"
source /home/vagrant/linc-website/venv/bin/activate
pip install pip --upgrade
pip install setuptools --upgrade
pip install -r /home/vagrant/linc-website/requirements.txt --upgrade
pip install -I Pillow
...
[program:linc-website]
command=/home/vagrant/linc-website/venv/bin/python /home/vagrant/linc-website/app/linc-webapp.py --port=5080
redirect_stderr=true
stdout_logfile=/tmp/linc-website.log
numprocs=1
user=vagrant
directory=/home/vagrant/app
